...
--   isAppView : IsAppView head args t

public export
data AppView : (t : TTImp) -> Type where
  MkAppView :  {t : TTImp} -> (head : (FC, Name)) -> (args : SnocList (Argument TTImp)) -> (0 isAppView : IsAppView head args t) -> AppView t
