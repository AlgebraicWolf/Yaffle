...
interface Bifunctor f where
  ...
  mapFst f = assert_total bimap f id
...
interface Foldable t where
  ...
  foldl f z t = assert_total foldr (flip (.) . flip f) id t z
  ...
  foldMap f = assert_total foldr ((<+>) . f) neutral
